...
/-!
# Adapter for the Lax-18 regularity lemma

Lax-18 states Szemerédi's regularity lemma using indexed vertex partitions
...
/-- Lax-18's real-valued density agrees with mathlib's edge density. -/
...
/-- A non-strict Lax-18 regular pair is a strict mathlib-uniform pair at any
larger parameter. -/
...
/-- A Lax-18 regular partition at parameter `eta / 4` is a mathlib-uniform
